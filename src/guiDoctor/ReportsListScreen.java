	...
	public void run() {
		...
		tag.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if(e.getKeyCode()!=KeyEvent.VK_BACK_SPACE) {
					String[]updatedList =ReportsListScreen.filterList(tag.getText()+e.getKeyChar());
					...
					if(tag.getText().equals("")) {
						...
						String[]updatedList =ReportsListScreen.filterList(search);
						ReportsListScreen.updateList(updatedList);
					}
				}
			}
		...
		tag.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String[]updatedList =ReportsListScreen.filterList(tag.getText());
				ReportsListScreen.updateList(updatedList);																																																			
			}																									
		});														
